...
static int allocate_data ( void )
{
	...
	u		= (float *) malloc ( 2*size*sizeof(float) );
	v		= (float *) malloc ( 2*size*sizeof(float) );
	u_prev		= (float *) malloc ( 2*size*sizeof(float) );
	v_prev		= (float *) malloc ( 2*size*sizeof(float) );
	dens		= (float *) malloc ( 2*size*sizeof(float) );	
	dens_prev	= (float *) malloc ( 2*size*sizeof(float) );
